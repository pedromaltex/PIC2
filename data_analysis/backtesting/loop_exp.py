...
for year in range(1995, 2025, 1):
    ...
    '''if year <= 1995:
        break
        sp500_data = sp500_data[sp500_data['Date'].dt.year <= year]
    else:
        sp500_data = sp500_data[(sp500_data['Date'].dt.year >= year-10) & 
                                    (sp500_data['Date'].dt.year <= year)]
    '''
    sp500_data = sp500_data[(sp500_data['Date'].dt.year >= year-10) & 
                                    (sp500_data['Date'].dt.year <= year)]
