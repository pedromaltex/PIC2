...
from regression import log_linear_regression, get_file, get_data
# %%
...
exp_average = log_linear_regression(sp500_data, name)[1]
y_pred_filtered = exp_average[mask.values]  # y_pred deve ter mesmo comprimento que sp500_data
